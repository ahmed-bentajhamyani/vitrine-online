...
<body>
    <div class="cont">
        <nav class="mynav fixed-top bg-dark">
            ...
            <div class="nav-links">
                <ul>
                    <li ><a href="/#latest">Derniers Articles</a></li>
                    <li ><a href="/showall">Categories</a></li>
                    <li ><a href="#contactus">Contactez-nous</a></li>
                </ul>
                
                <div class="auth">
                    @if (Route::has('login'))
                        <div class="hidden top-0 right-0 px-6 py-3 sm:block">
                            @auth
                                <a href="{{ url('/home') }}" class="mx-2"><i class="fa-solid fa-user"> </i> Home</a>
                                <a href="{{ url('panier')}}"><i class="fa-solid fa-cart-shopping"> </i>   Panier</a>
                            @else
                                <a href="{{ route('login') }}">Log in</a>

                                @if (Route::has('register'))
                                    <a href="{{ route('register') }}" class="ml-4">Register</i></a>
                                @endif
                            @endauth
                        </div>
                    @endif
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="inner-content">
                            <p>Copyright &copy; 2022 Evitrine</p>
                        </div>
                    </div>
                </div>
            </div>
